...
readFile(packageJsonPath) 
  ...
  .catch(
    // lidando com erro
    (error) => {
      console.error('Vish deu erro, mas posso tratar')
...
// multiplos promises - Promise.all

//  Promise.all([
//    Promise.resolve(1),
//    Promise.resolve(Error('a segunda falhou')),
//    Promise.resolve(3),
  // ...
//  ])  Promises [ r1, r2, r3, ... ]
...
//  .then(results =>
//    results.filter(r => r.status === 'fulfilled').map(r.value))
//    .then(console.log)
